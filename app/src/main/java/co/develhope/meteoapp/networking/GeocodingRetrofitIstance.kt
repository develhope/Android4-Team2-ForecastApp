...
class GeocodingRetrofitIstance {

    private val BASE_URL = "https://geocoding-api.open-meteo.com/"
    ...
    val geoMeteoApi : SearchInterface = retrofit.create(SearchInterface::class.java)
}